...
//        "<p>Registration code is valid for 1 hour</p>" +
        ...
        "<p>Welcome to the Flamecoin Exchange! </br></br>Best Regards,<br>The DeltaX Team";
...
exports.SendPasswordResetConfirmation = function(email, user, url, urlCheck, callback)
{
    ...
    const body = 
        ...
        "<p>Someone requested that the password for your Flamecoin Exchange account be reset</p>" +
        "<p>"+confirmHREF+"</p>" +
...
exports.SendWithdrawConfirmation = function(email, user, url, urlCheck, callback)
{
    ...
    const body = 
        "<h3>Hello "+unescape(user)+"</h3>" +
        "<p>Someone requested withdraw from your Flamecoin Exchange balance</p>" +
        "<p>"+confirmHREF+"</p>" +
